...
echo -e "${SP_CYAN}|${SP_RESET}                                                                            ${SP_CYAN}|${SP_RESET}"
echo -e "${SP_CYAN}|${SP_RESET}  ${SP_GREEN}*${SP_RESET} Source-available - no obfuscation, no encoded scripts.               ${SP_CYAN}|${SP_RESET}"
...
echo -e "${SP_CYAN}|${SP_RESET}  ${SP_BOLD}License${SP_RESET}  : ${SP_WHITE}Source-Available Software License${SP_RESET}                            ${SP_CYAN}|${SP_RESET}"
echo -e "${SP_CYAN}|${SP_RESET}                                                                            ${SP_CYAN}|${SP_RESET}"
